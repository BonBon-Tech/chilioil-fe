<template>
    ...
    <div class="header">
        ...
        <div class="header-left active d-flex justify-content-center">
            <router-link to="/dashboard" class="logo logo-normal" style="width: 80px !important;">
                <img src="@/assets/img/logo-main.png" alt="">
            </router-link>
            <router-link to="/dashboard" class="logo logo-white" style="width: 80px !important;">
                <img src="@/assets/img/logo-main.png" alt="">
            </router-link>
...
<!--                                type="settings"></vue-feather>Settings</router-link>-->
                        <hr class="m-0">
                        <router-link class="dropdown-item logout pb-0" to="/" @click="handleLogout"><img src="@/assets/img/icons/log-out.svg"
        ...
        <div class="dropdown mobile-user-menu">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <router-link class="dropdown-item" to="/" @click="handleLogout">Logout</router-link>
            </div>
        </div>
        <!-- /Mobile Menu -->
    </div>
