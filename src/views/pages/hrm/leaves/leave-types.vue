      ...
      <div class="page-header">
        ...
        <div class="page-btn">
          <a
            ...
            ><vue-feather type="plus-circle" class="me-2"></vue-feather>Add Leave type</a
          >
        </div>
      </div>
      <!-- /product list -->
        ...
        <div class="card-body">
          <div class="table-top">
            ...
            <div class="form-sort">
              ...
              <custom-select :options="TypeDate" id="typedate" placeholder="Sort by Date" />
            </div>
          </div>
          <!-- /Filter -->
          <div
...
export default {
  data() {
    return {
      filter: false,
      TypeStatus: ["Choose Status", "Active"],
      TypeDate: ["Sort by Date", "Newest", "Oldest"],
      TypeLeave: ["Choose Type", "Maternity", "Sick Leave"],
      data,
      columns,
    };
  },
