                ...
                <div class="layout-drop-item card">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      >
                        <span class="status-label"
                          ><i data-feather="menu" class="feather-menu"></i>Quantity</span
                        >
              ...
              <div class="row">
                <div class="col-lg-3 col-sm-6 col-12">
                  <div class="input-blocks">
                    ...
                    <custom-select :options="Hol" id="hol" placeholder="Choose Holiday" />
                  </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-12">
                  <div class="input-blocks">
                    <vue-feather type="users" class="info-img"></vue-feather>
                    <custom-select :options="HolHOD" id="holhod" placeholder="Choose HOD" />
                  </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-12">
                  <div class="input-blocks">
