...
export default {
  ...
  computed: {
    ...
    ...mapGetters("employee", ["employee", "employeeError"]),
    designationOptions() {
      return this.designations || [];
    },
  },
  methods: {
    ...mapActions("employee", ["updateEmployee", "clearError", "showEmployee"]),
  ...
  watch: {
    employee(newVal) {
      if (newVal) {
        this.setFormFromEmployee(newVal);
      }
    },
  },
  async mounted() {
    ...
    if (id) {
      ...
      if (this.employee) {
        this.setFormFromEmployee(this.employee);
      }
    }
  },
};
