      ...
      <div class="page-header">
        ...
        <div class="page-btn">
          <a
            ...
            ><vue-feather type="plus-circle" class="me-2"></vue-feather>Add New Shift</a
          >
        </div>
      </div>
      <!-- /product list -->
...
export default {
  data() {
    return {
      ...
      ShiftSort: ["Sort by Date", "Newest", "Oldest"],
      Shiftcho: ["Choose Shift", "Fixed", "Rotating", "Split", "On-Call", "Weekend"],
      Shiftsta: ["Choose Status", "Active", "Inactive"],
      data,
      columns,
    };
  },
