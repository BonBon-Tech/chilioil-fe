                ...
                <div class="company-info company-images">
                  ...
                  <div class="localization-info">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-sm-4">
                        <div class="localization-select">
                          <custom-select :options="Yearset" id="yearet" placeholder="2023" />
                        </div>
                      </div>
                    </div>
                    <div class="row align-items-center">
                ...
                <div class="company-info company-images">
                  ...
                  <div class="localization-info">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-sm-4">
                        <div class="localization-select">
                          <custom-select :options="Dotset" id="dotset" placeholder="." />
                        </div>
                      </div>
                    </div>
                    <div class="row align-items-center">
                      ...
                      <div class="col-sm-4">
                        <div class="localization-select">
                          <custom-select :options="Set" id="set" placeholder="," />
                        </div>
                      </div>
                    </div>
                  </div>
