      ...
      >
        ...
        <div class="d-sm-flex align-items-center">
          <div class="form-sort owned-by w-auto">
            ...
            <custom-select :options="Anyone" id="filenot" placeholder="Owned By Me" />
          </div>
              ...
              <div class="section-bulk-wrap">
                ...
                >
                  <div class="form-sort me-3">
                    ...
                    <custom-select :options="Recent" id="filealllast" placeholder="Recent" />
                  </div>
                  <div class="form-sort">
                          ...
                          <div class="group-avatar">
                            <span class="avatar">
                              <a
                                ...
                                aria-label="Member 1"
                                data-bs-original-title="Member 1"
                                ><img src="@/assets/img/avatar/avatar-6.jpg" alt="Avatar"
                              /></a>
                            </span>
                            <span class="avatar">
                              <a
                          ...
                          <div class="group-avatar">
                            ...
                            <span class="avatar">
                              <a
                                ...
                                aria-label="Member 2"
                                data-bs-original-title="Member 2"
                                ><img src="@/assets/img/avatar/avatar-5.jpg" alt="Avatar"
                              /></a>
                            </span>
                            <span class="count">
