            ...
            <div class="card table-list-card">
                ...
                :class="{ setclose: filter }">
                        ...
                        <div class="form-sort">
                            ...
                            <custom-select :options="Sort" id="sortby" placeholder="Sort by Date" />
                        </div>
                    </div>
                    <!-- /Filter -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="input-blocks">
                                                ...
                                                <custom-select :options="Choose" id="choose" placeholder="Choose Name" />
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="input-blocks">
                                                <vue-feather type="phone" class="info-img"></vue-feather>
                                                <custom-select :options="Calls" id="calls" placeholder="Choose Calls" />
                                            </div>
                                        </div>
