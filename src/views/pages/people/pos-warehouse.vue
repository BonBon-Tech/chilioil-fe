        ...
        <div class="card-body">
          <div class="table-top">
            ...
            <div class="form-sort">
              ...
              <custom-select :options="WarSort" id="warsort" placeholder="Sort by Date" />
            </div>
          </div>
          <!-- /Filter -->
          <div
              ...
              <template #bodyCell="{ column, record }">
                <template v-if="column.key === 'ContactPerson'">
                  <div class="userimgname">
                    ...
                    <a href="javascript:void(0);">{{ record.ContactPerson }}</a>
                  </div>
                </template>
