        ...
        <div class="card-body">
          <div class="table-top">
            ...
            <div class="form-sort">
              ...
              <custom-select :options="BrandSort" placeholder="Sort by Date" />
            </div>
          </div>
          <!-- /Filter -->
          <div
              ...
              <div class="row">
                <div class="col-lg-3 col-sm-6 col-12">
                  <div class="input-blocks">
                    ...
                    <custom-select :options="ChooseBrand" placeholder="Choose Brand" />
                  </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-12">
                  <div class="input-blocks">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                  <div class="input-blocks">
                    ...
                    <custom-select :options="BrandStatus" placeholder="Choose Status" />
                  </div>
                </div>
