                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="input-blocks">
                      ...
                      <custom-select :options="Quaint" id="quaint" placeholder="Choose" />
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="input-blocks">
                  ...
                  <div class="col-lg-12">
                    <div class="input-blocks">
                      ...
                      <custom-select :options="Gravely" id="gravely" placeholder="Choose" />
                    </div>
                  </div>
                </div>
                        ...
                        <table class="table datanew">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <custom-select :options="Addition" placeholder="Addition" />
                              </td>
                              <td class="action-table-data">
                                <div class="edit-delete-action">
                                  <a
...
export default {
  data() {
    return {
      Quaint: ["Choose", "Lobar Handy", "Quaint Warehouse"],
      Addition: ["Addition", "Addition", "Addition"],
      Gravely: ["Choose", "Steven", "Gravely"],
