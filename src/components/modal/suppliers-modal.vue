              ...
              <form @submit.prevent="submitForm">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-10 col-10">
                    <div class="input-blocks">
                      <label>Country</label>
                      <custom-select :options="GerSup" id="gersup" placeholder="Choose" />
                    </div>
                  </div>
              ...
              <form @submit.prevent="submitForm">
                <div class="row">
                  <div class="col-lg-12">
                    <div class="new-employee-field">
                      ...
                      <div class="profile-pic-upload edit-pic">
                        <div class="profile-pic">
                          <span
                            ><img src="@/assets/img/supplier/edit-supplier.jpg" alt=""
                          /></span>
                          <div class="close-img">
                  ...
                  <div class="col-lg-6 col-sm-10 col-10">
                    <div class="input-blocks">
                      <label>Country</label>
                      <custom-select :options="CouSup" id="cousup" placeholder="Germany" />
                    </div>
                  </div>
...
export default {
  data() {
    return {
      ChooseSup: ["Choose", "Varrel"],
      ChooseSupOne: ["Choose", "Varrel"],
      GerSup: ["Choose", "Germany", "Mexico"],
      CouSup: ["Germany", "Mexico"],
    };
  },
  methods: {
    submitForm() {
