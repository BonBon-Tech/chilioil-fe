              ...
              <div class="row">
                <div class="col-lg-6 pe-0">
                  <div class="mb-3">
                    ...
                    <custom-select :options="Barcode" id="barcode" placeholder="Choose" />
                  </div>
                </div>
                <div class="col-lg-6 pe-0">
                  <div class="mb-3">
                ...
                <div class="col-lg-6 pe-0">
                  <div class="mb-3">
                    ...
                    <custom-select :options="Taxtype" id="taxtype" placeholder="Choose" />
                  </div>
                </div>
                <div class="col-lg-6 pe-0">
                  <div class="mb-3">
                    <label class="form-label">Tax </label>
                    <custom-select :options="Tax" id="tax" placeholder="Choose" />
                  </div>
                </div>
                <div class="col-lg-12 pe-0">
                  <div class="mb-3">
                    <label class="form-label">Discount Type </label>
                    <custom-select :options="Discount" id="discount" placeholder="Choose" />
                  </div>
                </div>
                <div class="col-lg-12 pe-0">
                  <div>
